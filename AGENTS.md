...
- remember the MCP daemon rule: read tools work directly from workspace files; write tools (`tracker_patch`, `tracker_create_swimlane`, `tracker_update_swimlane`, `tracker_move_swimlane`, `tracker_delete_swimlane`, `tracker_start`, `tracker_pick`, `tracker_undo`, `tracker_redo`, `tracker_reload`) require the hub or daemon to be reachable
