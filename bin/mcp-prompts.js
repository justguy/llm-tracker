    ...
    case "tracker_patch_write":
      return makePrompt(
        ...
        [
          ...
          "Use `tracker_create_swimlane`, `tracker_update_swimlane`, `tracker_move_swimlane`, and `tracker_delete_swimlane` for lane add/update/move/remove when MCP is available; otherwise use `swimlaneOps` directly. Use `taskOps` for task move/archive/split/merge instead of full tracker rewrites.",
